...
#
#
# def flow_quantification01(sampling=20, search_extend=20, return_scalar_v=True,
#                         corr_mode='valid'):
#
#     if search_extend <= 0 and corr_mode=='valid':
#         print('WARNING: search_extend <=0 and valid mode! Flow will be zero!')
#
#     if search_extend == 0:
#         s_min = None
#         s_max = None
...
#                 b = b_windows[i,j]
#                 a_c = a - np.mean(a)
#                 b_c = b - np.mean(b[s_min:s_max,
#                                     s_min:s_max])
#                 corr = signal.correlate2d(b_c, a_c, mode=corr_mode)
#
...
def flow_quantification(frame_a, frame_b, mask, upsample=1, window_size=50,
                        ...
                        corr_tresh=0.5, outlier_thresh=1.5):
    """
